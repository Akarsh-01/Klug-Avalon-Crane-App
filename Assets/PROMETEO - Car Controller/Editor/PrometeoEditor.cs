...
public class PrometeoEditor : Editor{
  ...
  public override void OnInspectorGUI(){
    ...
    accelerationMultiplier.intValue = EditorGUILayout.IntSlider("Acceleration Multiplier:", accelerationMultiplier.intValue, 1, 3000);
    ...
    decelerationMultiplier.intValue = EditorGUILayout.IntSlider("Deceleration Multiplier:", decelerationMultiplier.intValue, 1, 1000);
